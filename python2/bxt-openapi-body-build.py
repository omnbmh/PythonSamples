...
def create_query_product_body():
    ...
    while i < times:
        ...
        for line in open("userid.txt"):
            json_body = "{'systemIdentify':'1','investAmount':'%d',prodNo:'%s','investorNo':'%s','yearIrr':0.0789}"
            prodNo = '20151130143540119526'
            userId = line.strip('\r\n')
            print userId
            json_body = json_body % (random.randint(1000, 2000),prodNo,userId)
            print json_body
